...
namespace dwarfsDiamond.models.Server
{
   public interface IGameMaster
    {
        ...
        string makeAction(string playerID, string roomID,string gameID, string actionID); //make action by playerID in roomID 
                                                                                         //game and return last action actionId
        IList<string> rebuildField(string playerID, string roomID, string gameID, string actionID);//return list of action after action with actionID, 
